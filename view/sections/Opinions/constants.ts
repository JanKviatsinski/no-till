import DraganchykMIhail from '../../../public/Draganchyk-MIhail.png'
...
export const opinions: Opinion[] = [
  ...
  },
  {
    ...
    name: 'Руслан Нерода',
    alt: 'Ruslan Neroda',
    text: 'Эта технология нуждается в адаптации не только к определенному региону а фактически к каждому хозяйству и каждому полю… Эта технология не для дураков. ...No-till  это одна из технологий не лучшая не худшая это всего лишь иной путь'
  },
  {
    img: MichaelHorsch,
    name: 'Майкл Хорш',
